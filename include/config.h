...
#define BASE_MAX_BALANCE_VELOCITY_FORWARD 25.0
#define BASE_MAX_BOOST_VELOCITY_FORWARD 36.0
#define BASE_MAX_BALANCE_VELOCITY_BACKWARD 20.0
#define BASE_MIN_STEERING_SENSITIVITY 15.0
#define BASE_MAX_STEERING_SENSITIVITY 35.0
